...
public class Driver extends JFrame{
    ...
    public static double acceptanceProbability(int currentConflict, int newConflict, double temp){
        ...
        else{return Math.exp((currentConflict-newConflict) / temp);}
    }
    public static void main(String[] args) {
        ...
        //solutions.getSchedules().forEach(schedule -> System.out.println("    "+driver.scheduleNumb++ +
        //"    | " + schedule + "   |   " +  schedule.getFitness() +" |  "+ schedule.getNumbOfConflicts()));  
        ...
        while (temp > 1) {
            ...
            //Schedule schedule2 = newSolution.getSchedules().get(0);
